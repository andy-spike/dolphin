...
import type { Difficulty, Source } from '@/mock/types'

const levels: Difficulty[] = ['beginner', 'intermediate', 'advanced']

export function BriefStation({ onDraft }: { onDraft: () => void }) {
        ...
        >
          <Field label="Topic" hint="The subject you want to learn.">
            <input
              ...
              autoFocus
              className="w-full border-b border-rule bg-transparent pb-2 title text-[1.3125rem] outline-none transition-colors placeholder:font-normal placeholder:text-ink-faint focus:border-accent"
            />
          </Field>
          ...
          <Field label="Time Budget" hint="Shapes how many Lessons the Course has.">
            <div className="flex items-baseline gap-3">
              <input
                ...
                className="w-24 border-b border-rule bg-transparent pb-1 numeral text-[1.625rem] outline-none transition-colors focus:border-accent"
              />
