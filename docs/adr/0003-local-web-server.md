...
**Consequences**: Dolphin owns the application data, account access, Sandbox coordination, Usage reporting, export, and permanent deletion. The Student still owns their Course content through export and deletion controls.
